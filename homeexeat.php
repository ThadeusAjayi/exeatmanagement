...
if(!isset($_SESSION['user'])){
	...
	if(isset($_POST['submit'])){
		header("Location: homeexeat.php?status=error&msg=Leave application submitted successfully");
		if($_POST['hall'] != "" && $_POST['purpose'] != "" && $_POST['parent'] != "" && $_POST['pcontact'] != "" && $_POST['sDate'] != "" && $_POST['eDate'] != ""){
			$type = "Home Exeat";
			...
			//$sql = "SELECT * FROM leave_application WHERE leave_type='".$_SESSION['type']."'";
			...
			if($result < 3){
				...
				if(mysqli_query($con, $sql)){
					header("Location: homeexeat.php?status=success&msg=Leave application submitted successfully") or die(mysqli_error($con, $sql));
				}
			}else{
				header("Location: homeexeat.php?status=error&msg=Maximum Number of Home Exeats Reached For This Semester");
			}
		}else{
			header("Location: homeexeat.php?status=error&msg=Fill All Fields");
		}
								...
								<div class="col-md-5 col-md-offset-1">
									<form name="form" id="form">
									  <select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)" class="form-control">
										<option value="homeexeat.php" selected>Home Exeat</option>
							...
							<div class="row form-control">
								<div class="form-group">
									...
									<div  class="col-md-6 col-md-offset-2">
										<input type="text" disabled value="Home Exeat" class="form-control" name="exeat-type" />
									</div>
								</div>
							</div>
							...
							<div class="row form-control">
								<div class="form-group">
									...
									<div class="col-md-6 col-md-offset-1">
										<textarea class="form-control" maxlength="300" style="min-height: 200px;" placeholder="300 Characters Max" name="purpose"></textarea>
									</div>
								</div>
							</div>
